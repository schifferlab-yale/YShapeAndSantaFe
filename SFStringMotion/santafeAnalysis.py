...
class SantaFeLattice:
    def __init__(self,csvFile,firstCenter=None,removeEdgeStrings=True,autoAlignCenters=False, randomizeStringColor=False,vertexEnergies=None):
        ...
        self.shouldRemoveEdgeStrings=removeEdgeStrings
        self.autoAlignCenters=autoAlignCenters
        ...
        self.firstRowHorizontal=firstRowHorizontal
    ...
    def genCenters(self):
        if(self.autoAlignCenters):
            self.updateCenters()
            firstCenter=self.findFirstCenter()
            self.updateCentersFromPattern(firstCenter)
        else:
            if self.firstCenter is None:
                self.updateCenters()
            else:
                self.updateCentersFromPattern(self.firstCenter)

    def updateFromRawDataChange(self):
        self.updateArrowData(self.firstRowHorizontal)
        self.updateDimers()
        self.genCenters()
        self.updateStrings()    
